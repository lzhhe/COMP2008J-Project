...
public void testCalculateCount() throws Exception {
    ...
    Card card1  = new PropertyCard(2,"",null,new int[4], Colour.BLACK);
    Card card2  = new PropertyCard(3,"",null,new int[4], Colour.BLACK);
    Card card3  = new PropertyCard(4,"",null,new int[4], Colour.BLACK);
...
public void testCalculateProperty() throws Exception {
    ...
    PropertyCard card1  = new PropertyCard(2,"",null,new int[4], Colour.BLACK);
    PropertyCard card2  = new PropertyCard(3,"",null,new int[4], Colour.BLACK);
    clist1.add(card1);
    clist1.add(card2);
    player.propertiesByColour.put(Colour.BLACK,clist1);
...
public void testTotalValue() throws Exception {
    ...
    ArrayList<PropertyCard> clist1=new ArrayList<>();
    PropertyCard card4  = new PropertyCard(2,"",null,new int[4], Colour.BLACK);
    PropertyCard card5  = new PropertyCard(3,"",null,new int[4], Colour.BLACK);
    clist1.add(card4);
    clist1.add(card5);
    player.propertiesByColour.put(Colour.BLACK,clist1);
    ArrayList<PropertyCard> clist2=new ArrayList<>();
...
public void testCompleteSet() throws Exception { 
    ...
    PropertyCard card1  = new PropertyCard(2,"",null,new int[4], Colour.BLACK);
    PropertyCard card2  = new PropertyCard(3,"",null,new int[4], Colour.BLACK);
    PropertyCard card3  = new PropertyCard(5,"",null,new int[4], Colour.BLACK);
    PropertyCard card4  = new PropertyCard(6,"",null,new int[4], Colour.BLACK);
    clist1.add(card1);
    clist1.add(card2);
    clist1.add(card3);
    clist1.add(card4);
    player.propertiesByColour.put(Colour.BLACK,clist1);
    Assert.assertEquals(player.completeSet(clist1),true);
    
    ArrayList<PropertyCard> clist2=new ArrayList<>();
    PropertyCard card5  = new PropertyCard(2,"",null,new int[4], Colour.BLACK);
    PropertyCard card6  = new PropertyCard(3,"",null,new int[4], Colour.BLACK);
    PropertyCard card7  = new PropertyCard(5,"",null,new int[4], Colour.BLACK);
    clist2.add(card5);
    clist2.add(card6);
    clist2.add(card7);
  
    player.propertiesByColour.put(Colour.BLACK,clist2);
    Assert.assertEquals(player.completeSet(clist2),false);
...
public void testWinGame() throws Exception { 
	...
	ArrayList<PropertyCard> clist1=new ArrayList<>();
    PropertyCard card1  = new PropertyCard(2,"",null,new int[]{1, 2, 3, 4}, Colour.BLACK);
    PropertyCard card2  = new PropertyCard(3,"",null,new int[]{1, 2, 3, 4}, Colour.BLACK);
    PropertyCard card3  = new PropertyCard(5,"",null,new int[]{1, 2, 3, 4}, Colour.BLACK);
    PropertyCard card4  = new PropertyCard(6,"",null,new int[]{1, 2, 3, 4}, Colour.BLACK);
    clist1.add(card1);
    clist1.add(card2);
    clist1.add(card3);
    clist1.add(card4);
    ...
    Assert.assertEquals(player.winGame(),false);
    
    PropertyCard card11  = new PropertyCard(3,"",null,new int[]{2,3,6}, Colour.RED);
    clist3.add(card11);
    player.propertiesByColour.put(Colour.RED,clist3);
    Assert.assertEquals(player.winGame(),true);
}
